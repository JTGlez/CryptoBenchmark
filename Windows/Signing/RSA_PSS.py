...
def signing(file):
    ...
    privatekey = RSA.import_key(open('Windows/Signing/private.pem').read(), frase)
    ...
    publickey = RSA.import_key(open('Windows/Signing/public.pem').read())
    hash = SHA256.new(archivo)
