...
def sha3_384(file):
    """Obtiene el Hash de un archivo dado usando SHA-3 384"""
...
def benchmark_password(password):
    ...
    start = time.time()
    hash_object = SHA3_384.new(password)
