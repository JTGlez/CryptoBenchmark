...
def generate_pk():
    ...
    with open("/content/CryptoBenchmark/Linux/Signing/private_key_ed25519.pem", "wb") as f:
...
def signing(file):
    ...
    with open("/content/CryptoBenchmark/Linux/Signing/private_key_ed25519.pem", "rb") as f:
