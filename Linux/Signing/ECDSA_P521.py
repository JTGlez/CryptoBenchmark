...
def generate_pk():
    ...
    with open("/content/CryptoBenchmark/Linux/Signing/private_key_secp521r1.pem", "wb") as f:
...
def signing(file):
    ...
    with open("/content/CryptoBenchmark/Linux/Signing/private_key_secp521r1.pem", "rb") as f:
