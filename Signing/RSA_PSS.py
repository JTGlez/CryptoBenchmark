...
def signing(file):
    ...
    privatekey = RSA.import_key(open('Signing/private.pem').read(), frase)
    ...
    publickey = RSA.import_key(open('Signing/public.pem').read())
    hash = SHA256.new(archivo)
